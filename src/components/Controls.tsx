          ...
          {availableCountries.map(country => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-lg border transition-all text-sm text-left group
                ...
                `}
              >
                <div className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${isSelected ? 'border-primary bg-primary' : 'group-hover:border-foreground/40'}`}>
